...
export default function AluminiDisplay({ team }) {
            ...
            >
              ...
              <div className={styles.membersGrid}>
                {members.map((member, index) => {
                  ...
                  const socials = {};
                  if (member.links.linkedin?.trim()) {
                    let ln = member.links.linkedin.trim();
                    socials.linkedin = ln.startsWith("http")
                      ? ln
                      : `https://${ln}`;
                  }
                  if (member.links.facebook?.trim()) {
                    socials.facebook = member.links.facebook.trim();
                  }
                  ...
                  return (
                    <div key={index} className={styles.memberCard}>
                      ...
                      <div className={styles.metaZone}>
                        ...
                        {member.company && (
                          <p className={styles.company}>{member.company}</p>
                        )}
